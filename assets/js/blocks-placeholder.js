...
registerBlockType( 'product-blocks/advance-list', {
    title: __( 'Advance List', 'product-blocks' )
});
registerBlockType( 'product-blocks/list', {
    title: __( 'List', 'product-blocks' )
});
registerBlockType( 'product-blocks/banner', {
    title: __( 'Banner', 'product-blocks' )
});
...
registerBlockType( 'product-blocks/product-search', {
    title: __( 'Product Search', 'product-blocks' )
});
...
registerBlockType( 'product-blocks/menu-wishlist', {
    title: __( 'Menu Wishlist', 'product-blocks' )
});